...
# Set DPI Awareness (Windows 10/8)  https://learn.microsoft.com/en-us/windows/win32/api/shellscalingapi/nf-shellscalingapi-setprocessdpiawareness
import ctypes
...
class Capture:
    ...
    def get_screenshot(self):
        ...
        img = frombuffer(dataBitMap.GetBitmapBits(True), dtype='uint8').reshape((self.h, self.w, 4))
        #img.shape = (self.h, self.w, 4)
        #img = ascontiguousarray(frombuffer(dataBitMap.GetBitmapBits(True), dtype='uint8').reshape((self.h, self.w, 4)))
